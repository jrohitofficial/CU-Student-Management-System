        ...
        (function(a) {
                ...
                if (this.sliderElem) s = !0;
                    ...
                    if (
                        (z &&
                            ...
                            q.setAttribute("aria-labelledby", this.options.labelledby[1]), !z &&
                ...
                if (
                    (a &&
                        ...
                        (this._removeClass(this.sliderElem, "slider-horizontal"),
                            ...
                            this._removeClass(this.tooltip_max, "hide"), ["left", "right", "top", "width", "height"].forEach(function(a) {
                    ...
                    linear: {
                        ...
                        toValue: function(a) {
                            ...
                            if (this.options.ticks_positions.length > 0) {
                                for (
                                    var d, e, f, g = 0, i = 1; i < this.options.ticks_positions.length; i++
                                )
            ...
            (d.prototype = {
                ...
                _removeSliderEventHandlers: function() {
                    if (
                        ...
                        for (
                            ...
                            a[b].removeEventListener(
                                "mouseleave",
                                this.ticksCallbackMap[b].mouseLeave, !1
                            );
                        this.handleCallbackMap.handle1 &&
                            this.handleCallbackMap.handle2 &&
                            (this.handle1.removeEventListener(
                                    "mouseenter",
                                    this.handleCallbackMap.handle1.mouseEnter, !1
                                ),
                                this.handle2.removeEventListener(
                                    "mouseenter",
                                    this.handleCallbackMap.handle2.mouseEnter, !1
                                ),
                                this.handle1.removeEventListener(
                                    "mouseleave",
                                    this.handleCallbackMap.handle1.mouseLeave, !1
                                ),
                                this.handle2.removeEventListener(
                                    "mouseleave",
                                    this.handleCallbackMap.handle2.mouseLeave, !1
                                ));
                    }
                    ...
                    if (
                        ...
                        if (this.tickLabelContainer) {
                            ...
                            if (0 === this.options.ticks_positions.length)
                                ...
                                for (
                                    l = 0; l < this.tickLabelContainer.childNodes.length; l++
                                )
                ...
                _keydown: function(a, b) {
                    ...
                    if (c) {
                        ...
                        if (this.ticksAreValid && this.options.lock_to_ticks) {
                            var i = void 0;
                            (i = this.options.ticks.indexOf(this._state.value[a])), -1 === i &&
                                ((i = 0),
                                    window.console.warn(
                ...
                _snapToClosestTick: function(a) {
                    for (
                        var b = [a, 1 / 0], c = 0; c < this.options.ticks.length; c++
                    ) {
                ...
                _getClosestTickIndex: function(a) {
                    for (
                        var b = Math.abs(a - this.options.ticks[0]), c = 0, d = 0; d < this.options.ticks.length;
                        ++d
                    ) {
